...
while cap.isOpened():
    ...
    humans = human_cascade.detectMultiScale(frame1, scaleFactor=1.1, minNeighbors=5, minSize=(50, 50))
    for (hx, hy, hw, hh) in humans:
        cv2.rectangle(frame1, (hx, hy), (hx + hw, hy + hh), (255, 0, 0), 2)
        cv2.putText(frame1, 'Human', (hx, hy - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 0, 0), 2)
    ...
    # else:
    #     # If no motion is detected for a certain duration, stop saving
    #     print("No motion detected. Stopping saving...")
    #     break
